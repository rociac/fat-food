...
export const pizza = `
          <img class="main__card-content-left" src="src/assets/pizza.jpg">
...
export const hamburger = `
          <img class="main__card-content-left" src="src/assets/hamburger.jpg">
...
export const wings = `
          <img class="main__card-content-left" src="src/assets/wings.jpg">
...
export const reservations = `
          <img class="main__card-content-left" src="src/assets/deep-dish.jpg">

          <p class="main__card-content-right">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis fugit eos
            aliquam
            beatae aut ullam, non, nemo accusamus corporis temporibus quasi? Harum, minus. Voluptatem itaque cumque sequi
            earum inventore expedita quasi est tenetur saepe nostrum commodi quod quisquam, error magnam recusandae
            corporis
            pit accusantium in. Nam quos temporibus unde.</p>
`;
